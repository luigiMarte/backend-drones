...
router.put("/:userId", _index.verifyToken, userController.updateUserById);
router.post("/favorites/:userId", _index.verifyToken, userController.updateFavorites);
...
// delete user
router["delete"]("/:userId", _index.verifyToken, userController.deleteUser);
var _default = router;
